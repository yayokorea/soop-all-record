...
// @description:zh-CN  将 SOOP 直播流直接保存到磁盘，无需重新编码并保留原始画质。
// @description:th     บันทึกไลฟ์สตรีม SOOP ลงดิสก์โดยตรงโดยไม่เข้ารหัสใหม่ และคงคุณภาพของสตรีมต้นฉบับไว้
// @description:vi     Ghi trực tiếp livestream SOOP vào ổ đĩa mà không mã hóa lại, giữ nguyên chất lượng luồng gốc.
// @description:id     Merekam live stream SOOP langsung ke disk tanpa re-encoding dan mempertahankan kualitas stream asli.
// @license            MIT
